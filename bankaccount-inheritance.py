...
class Transaction:
    def __init__(self, date: datetime.date, transaction_type: str, amount: float, currency: str) -> object:
    ...
    def __repr__(self):
        return f"Date: {self.date}: {self.transaction_type} - {self.amount}{self.currency}"


class Deposit(Transaction):
    def __init__(self, date: datetime.date, transaction_type: str, amount: float, currency: str):
        super().__init__(date: datetime.date, transaction_type: str, amount: float, currency: str)


class Withdraw(Transaction):
    def __init__(self, date, transaction_type: str, amount: float, currency: str): -> bool
        super().__init__(date, transaction_type: str, amount: float, currency: str)
...
class Conversion(Transaction):
    def __init__(self, date, transaction_type: str, amount: float, currency: str,
                 nis2usd_exchange_rate:float):

        super().__init__(date, transaction_type: str, amount: float, currency: str)

        self.nis2usd_exchange_rate = 3.5


    def  __str__(self):
        return f"your transaction is:{self.transaction_type}, with amount of: {self.amount}"
        ...
        def _add_transaction(self, transaction_type: str, amount: float, currency: str):
            ...
            Transaction(transaction_type, amount, currency))
                ...
                if __name__ == '__main__':
                        # create bank account
                    account1 = BankAccount('Discont', 'Kiryat Hasharon', 12345,
